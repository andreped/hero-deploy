...
ActiveRecord::Schema.define(version: 20220929194752) do
  ...
  create_table "kuroko2_admin_assignments", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.bigint "user_id", null: false
    t.bigint "job_definition_id", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "kuroko2_ar_internal_metadata", primary_key: "key", id: :string, collation: "utf8_general_ci", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.string "value"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "kuroko2_execution_histories", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.string "hostname", limit: 180
    t.integer "worker_id", limit: 1
    t.string "queue", limit: 180, default: "@default", null: false
    t.bigint "job_definition_id", null: false
  ...
  create_table "kuroko2_executions", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.string "uuid", limit: 36, null: false
    t.bigint "job_definition_id"
    t.integer "job_definition_version"
    t.integer "job_instance_id"
  ...
  create_table "kuroko2_job_definition_tags", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.bigint "job_definition_id", null: false
    t.integer "tag_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "kuroko2_job_definitions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer "version", default: 0, null: false
    t.string "name", limit: 180, null: false
    t.text "description", null: false
    t.text "script", null: false
  ...
  create_table "kuroko2_job_instances", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.bigint "job_definition_id"
    t.integer "job_definition_version"
    t.text "script"
    t.datetime "finished_at"
  ...
  create_table "kuroko2_job_schedules", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.bigint "job_definition_id"
    t.string "cron", limit: 180
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "kuroko2_job_suspend_schedules", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.bigint "job_definition_id"
    t.string "cron", limit: 180
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "kuroko2_logs", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer "job_instance_id"
  ...
  create_table "kuroko2_memory_consumption_logs", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer "job_instance_id"
  ...
  create_table "kuroko2_memory_expectancies", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
  ...
  create_table "kuroko2_process_signals", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
  ...
  create_table "kuroko2_schema_migrations", primary_key: "version", id: :string, collation: "utf8_general_ci", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
  end

  create_table "kuroko2_script_revisions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.bigint "job_definition_id", null: false
    t.text "script", null: false
    t.bigint "user_id"
  ...
  create_table "kuroko2_stars", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.bigint "user_id", null: false
    t.bigint "job_definition_id", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "kuroko2_tags", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
  ...
  create_table "kuroko2_ticks", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.datetime "at"
  end

  create_table "kuroko2_tokens", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.string "uuid", limit: 36, null: false
    t.bigint "job_definition_id"
    t.integer "job_definition_version"
    t.integer "job_instance_id"
  ...
  create_table "kuroko2_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
  ...
  create_table "kuroko2_workers", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
  ...
  add_foreign_key "kuroko2_script_revisions", "kuroko2_job_definitions", column: "job_definition_id"
  add_foreign_key "kuroko2_script_revisions", "kuroko2_users", column: "user_id"
